...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if(!interaction.member.permissions.has(PermissionsBitField.Flags.MuteMembers)) return interaction.reply({content: "<:carpiii:1214250638691803176> | Üyeleri Sustur Yetkin Yok!", ephemeral: true})
